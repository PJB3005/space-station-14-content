...
{
    public class TicketManager : ITicketManager, IEntityEventSubscriber
    {
        ...
        public void Initialize()
        {
            ...
            _netManager.RegisterNetMessage<MsgViewTicket>(ViewTicket);
            _netManager.RegisterNetMessage<AdminMenuTicketListRequest>(HandleTicketListRequest);
            _netManager.RegisterNetMessage<AdminMenuTicketListMessage>();
        }
        ...
        private void RunLevelChanged(GameRunLevelChangedEvent level)
        {
            if (level.New == GameRunLevel.PreRoundLobby)
            {
                CurrentId = 0;
                Tickets.Clear();
            }
