...
namespace Content.Shared.GameObjects.EntitySystems
{
    public partial class SharedInteractionSystem
    {
            ...
            Ignored predicate = null)
        {
            ...
            var rayResults = _physicsManager
            ...
            bool popup = false)
        {
            ...
            var inRange = InRangeUnobstructed(originPosition, otherPosition, range, collisionMask, predicate,
                ignoreInsideBlocker);
            ...
            bool popup = false)
        {
            ...
            var inRange = InRangeUnobstructed(originPosition, other, range, collisionMask, predicate,
                ignoreInsideBlocker);
            ...
            bool popup = false)
        {
            ...
            return InRangeUnobstructed(user, otherPosition, range, collisionMask, predicate, ignoreInsideBlocker,
                popup);
        }
    }
}
